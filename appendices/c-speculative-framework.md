...
For the real physics gaps that motivate this framework, see [Appendix B](b-physics-boundaries.md).
...
### 2.1 Inertial Mass Reduction (Speculative Ansatz)
...
The only honest demand is unchanged: **demand the radar tapes, the sensor metadata, the platform logs, the reconstruction methodology.** Let us test whether the gap is real or a shadow of missing information. The math is a map of the void, not a bridge across it.
