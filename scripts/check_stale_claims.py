...
FORBIDDEN = [
    ...
    ("archived for lack", "Unverified AARO wording -- use 'remained unresolved or lacked sufficient data'"),
    ("444 cases archived", "Unverified AARO wording -- use 'remained unresolved or lacked sufficient data'"),
    ("444 archived", "Unverified AARO wording -- use 'remained unresolved or lacked sufficient data'"),
