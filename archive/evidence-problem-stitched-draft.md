...
Ordinary Standard Model calculations assume a fixed spacetime background, while general relativity makes spacetime dynamical. General relativity treats gravity and spacetime classically, with matter represented through the classical stress-energy tensor rather than through a full quantum-gravitational description. Where these frameworks meet — the Planck scale, approximately $10^{-35}$ meters — is a regime of genuinely unknown physics. [^25^] The speculative propulsion models that appear in UAP discourse demand engineering control not at the Planck scale but at everyday scales — meters to kilometers — while somehow retaining quantum coherence across those distances. That is the missing floor: a theory of macroscopic quantum spacetime engineering that does not exist in the public scientific literature.
...
In standard QFT, the vacuum state $|0\rangle$ has zero mean fields but nonzero correlations. The hypothetical physics would need to treat these correlations as a manipulable medium — something closer to a superfluid or quantum Hall system than to empty space. This would require three capabilities, none of which currently exists:
...
The power problem alone is prohibitive. Suppose a craft attempts to maintain coherence via dynamical decoupling. The power required to suppress natural decoherence scales as $P \sim \alpha^2 m_0 c^2 / \tau_{\text{dec}}$, where $\tau_{\text{dec}}$ is the decoherence timescale. For a $10^4$-kg object with $\tau_{\text{dec}} \sim 10^{-30}$ s, $P \sim 10^{50}$ W — exceeding the power output of the Sun by many orders of magnitude. Quantum error correction could, in principle, reduce this burden if a fault-tolerant threshold exists, but no quantum error correction has been demonstrated for the relevant macroscopic degrees of freedom of a room-temperature extended object, let alone a vehicle interacting with atmosphere or water. [^50^]
